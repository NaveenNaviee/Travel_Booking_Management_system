...
--create database Travel_Booking_ManagementProject; 
--use Travel_Booking_ManagementProject; 

CREATE TABLE CustomerDetails_reneeka (
...
--select * from CustomerDetails_reneeka;
